    ...
    let parse' (getEnvironmentVariable : string -> string option) (args : string list) : BasicNoPositionals =
        let helpText () =
            [
                ...
                (sprintf "%s  %s%s%s" (sprintf "--%s" "bar") "string" "" "")
                (sprintf "%s  %s%s%s" (sprintf "--%s" "baz") "bool" "" "")
                (sprintf "%s  %s%s%s" (sprintf "--%s" "rest") "int32" " (can be repeated)" "")
            ]
            |> String.concat "\n"
...
module Basic =
    let parse' (getEnvironmentVariable : string -> string option) (args : string list) : Basic =
        let helpText () =
            [
                (sprintf "%s  %s%s%s" (sprintf "--%s" "foo") "int32" "" (sprintf " : %s" ("This is a foo!")))
                (sprintf "%s  %s%s%s" (sprintf "--%s" "bar") "string" "" "")
                (sprintf "%s  %s%s%s" (sprintf "--%s" "baz") "bool" "" "")
                (sprintf
                    "%s  %s%s%s"
    ...
    let parse' (getEnvironmentVariable : string -> string option) (args : string list) : LoadsOfTypes =
        let helpText () =
            [
                ...
                (sprintf "%s  %s%s%s" (sprintf "--%s" "bar") "string" "" "")
                (sprintf "%s  %s%s%s" (sprintf "--%s" "baz") "bool" "" "")
                (sprintf "%s  %s%s%s" (sprintf "--%s" "some-file") "FileInfo" "" "")
                (sprintf "%s  %s%s%s" (sprintf "--%s" "some-directory") "DirectoryInfo" "" "")
                (sprintf "%s  %s%s%s" (sprintf "--%s" "some-list") "DirectoryInfo" " (can be repeated)" "")
                (sprintf "%s  %s%s%s" (sprintf "--%s" "optional-thing-with-no-default") "int32" " (optional)" "")

                (sprintf
                    "%s  %s%s%s"
                    (sprintf "--%s" "optional-thing")
                    "bool"
                    (LoadsOfTypes.DefaultOptionalThing().ToString ()
                ...
                (sprintf
                    ...
                    "int32"
                    (LoadsOfTypes.DefaultAnotherOptionalThing().ToString ()
                     |> sprintf " (default value: %s)")
                    "")
                ...
                (sprintf
                    ...
                    "")
                (sprintf "%s  %s%s%s" (sprintf "--%s" "positionals") "int32" " (positional args) (can be repeated)" "")
            ]
            |> String.concat "\n"
                ...
                SomeFile =
                    (match arg_3 with
                     ...
                     | None ->
                         failwith
                             "WoofWare.Myriad internal error in generated parser: required argument missing after successful parse")
                SomeList = (arg_5 |> Seq.toList)
                YetAnotherOptionalThing =
                    (match arg_10 with
                     | Some x -> x
                     | None ->
                         failwith
        ...
        let helpText () =
            [
                ...
                (sprintf
                    ...
                    (sprintf "--%s" "optional-thing")
                    "bool"
                    (LoadsOfTypesNoPositionals.DefaultOptionalThing().ToString ()
                     |> sprintf " (default value: %s)")
                    "")
                ...
                (sprintf
                    ...
                    (sprintf "--%s" "another-optional-thing")
                    "int32"
                    (LoadsOfTypesNoPositionals.DefaultAnotherOptionalThing().ToString ()
                     |> sprintf " (default value: %s)")
                    "")
                (sprintf
                    "%s  %s%s%s"
...
module DatesAndTimesArgParse =
    ...
    type DatesAndTimes with
        ...
        static member parse' (getEnvironmentVariable : string -> string option) (args : string list) : DatesAndTimes =
            let helpText () =
                [
                    (sprintf "%s  %s%s%s" (sprintf "--%s" "plain") "TimeSpan" "" "")
                    (sprintf "%s  %s%s%s" (sprintf "--%s" "invariant") "TimeSpan" "" "")
...
/// Methods to parse arguments for the type ParentRecordOptionalChild
[<AutoOpen>]
module ParentRecordOptionalChildArgParse =
    /// Extension methods for argument parsing
    type ParentRecordOptionalChild with

        static member parse'
            (getEnvironmentVariable : string -> string option)
            (args : string list)
            : ParentRecordOptionalChild
            =
            let helpText () =
                [
                    (sprintf "%s:" "Child (optional)")
                    (sprintf "  %s  %s%s%s" (sprintf "--%s" "thing1") "int32" "" "")
                    (sprintf "  %s  %s%s%s" (sprintf "--%s" "thing2") "string" "" "")
                    (sprintf "%s  %s%s%s" (sprintf "--%s" "and-another") "bool" "" "")
                ]
            ...
            let parser_schema : ArgParserRuntime_BasicNoPositionals.ErasedSchema =
                {
                    ...
                    Tree =
                        (ArgParserRuntime_BasicNoPositionals.ErasedTree.Product (
                            [
                                ArgParserRuntime_BasicNoPositionals.ErasedTree.Sum (
                                    (0,
                                     [
                                         ("supplied",
                                          ArgParserRuntime_BasicNoPositionals.ErasedTree.Product (
                                         ...
                                         ("absent", ArgParserRuntime_BasicNoPositionals.ErasedTree.Product (List.empty))
                                     ])
                                )
                                ArgParserRuntime_BasicNoPositionals.ErasedTree.Leaf 2
                            ]
        ...
        static member parse (args : string list) : ParentRecordOptionalChild =
            ParentRecordOptionalChild.parse' (System.Environment.GetEnvironmentVariable >> Option.ofObj) args
namespace ConsumePlugin
...
/// Methods to parse arguments for the type ParentRecordOptionalChildPos
[<AutoOpen>]
module ParentRecordOptionalChildPosArgParse =
    /// Extension methods for argument parsing
    type ParentRecordOptionalChildPos with

        static member parse'
            (getEnvironmentVariable : string -> string option)
            (args : string list)
            : ParentRecordOptionalChildPos
            =
            let helpText () =
                [
                    (sprintf "%s: %s" "Child (optional)" ("Settings for the child thing"))
                    (sprintf "  %s  %s%s%s" (sprintf "--%s" "thing1") "int32" "" "")
                    (sprintf "  %s  %s%s%s" (sprintf "--%s" "thing2") "URI" " (positional args) (can be repeated)" "")
                ]
                |> String.concat "\n"

            let arg_2 : Uri ResizeArray = ResizeArray ()
            let mutable arg_1 : int option = None
            ...
            let parser_storePositional (positionalId : int) (value : string) (afterSeparator : bool) : string option =
                ...
                | 0 ->
                    try
                        arg_2.Add (value |> (fun x -> System.Uri x))
                        None
                    with _ as exc ->
                        (sprintf "%s (at arg %s)" exc.Message value) |> Some
                | _ -> failwith "WoofWare.Myriad internal error in generated parser: unknown positional sink id"
        ...
        static member parse (args : string list) : ParentRecordOptionalChildPos =
            ParentRecordOptionalChildPos.parse' (System.Environment.GetEnvironmentVariable >> Option.ofObj) args
namespace ConsumePlugin
...
/// Methods to parse arguments for the type ParentRecordDefaultedChild
[<AutoOpen>]
module ParentRecordDefaultedChildArgParse =
    /// Extension methods for argument parsing
    type ParentRecordDefaultedChild with

        static member parse'
            (getEnvironmentVariable : string -> string option)
            (args : string list)
            : ParentRecordDefaultedChild
            =
            let helpText () =
                [
                    (sprintf "%s:" "Child (optional; a default is used if omitted)")
                    (sprintf "  %s  %s%s%s" (sprintf "--%s" "thing1") "int32" "" "")
                    (sprintf "  %s  %s%s%s" (sprintf "--%s" "thing2") "string" "" "")
                    (sprintf "%s  %s%s%s" (sprintf "--%s" "and-another") "bool" "" "")
                ]
            ...
            | ArgParserRuntime_BasicNoPositionals.ParseOutcome.Success parser_selection ->
                {
                    ...
                    Child =
                        ...
                        | Some 1 -> Choice2Of2 (ParentRecordDefaultedChild.DefaultChild ())
                        | _ ->
                            failwith
                                "WoofWare.Myriad internal error in generated parser: no case selected despite a successful parse"
                }
        ...
        static member parse (args : string list) : ParentRecordDefaultedChild =
            ParentRecordDefaultedChild.parse' (System.Environment.GetEnvironmentVariable >> Option.ofObj) args
namespace ConsumePlugin
...
/// Methods to parse arguments for the type ParentRecordNestedOptional
[<AutoOpen>]
module ParentRecordNestedOptionalArgParse =
    /// Extension methods for argument parsing
    type ParentRecordNestedOptional with

        static member parse'
            (getEnvironmentVariable : string -> string option)
            (args : string list)
            : ParentRecordNestedOptional
            =
            let helpText () =
                [
                    (sprintf "%s:" "Child (optional)")
                    (sprintf "  %s  %s%s%s" (sprintf "--%s" "db-thing1") "int32" "" "")
                    (sprintf "%s:" "  Grandchild (optional)")
                    (sprintf "    %s  %s%s%s" (sprintf "--%s" "db-deep") "int32" "" "")
                ]
                |> String.concat "\n"
                    ...
                    Child =
                        ...
                        | Some 0 ->
                            Some (
                                {
                                    Grandchild =
                                        match Map.tryFind 2 parser_selection.Choices with
                                        | Some 0 ->
                                            Some (
                                                {
                                                    Deep =
        ...
        static member parse (args : string list) : ParentRecordNestedOptional =
            ParentRecordNestedOptional.parse' (System.Environment.GetEnvironmentVariable >> Option.ofObj) args
namespace ConsumePlugin
...
module ChoicePositionalsArgParse =
    ...
    type ChoicePositionals with
        ...
        static member parse'
            ...
            let helpText () =
                [
                    (sprintf "%s  %s%s%s" (sprintf "--%s" "args") "string" " (positional args) (can be repeated)" "")
                ]
                |> String.concat "\n"
...
module WithFlagDuArgParse =
    ...
    type WithFlagDu with
        ...
        static member parse' (getEnvironmentVariable : string -> string option) (args : string list) : WithFlagDu =
            let helpText () =
                [ (sprintf "%s  %s%s%s" (sprintf "--%s" "dry-run") "bool" "" "") ]
                |> String.concat "\n"
...
module ManyLongFormsArgParse =
    ...
    type ManyLongForms with
        ...
        static member parse' (getEnvironmentVariable : string -> string option) (args : string list) : ManyLongForms =
            let helpText () =
                [
                    (sprintf "%s  %s%s%s" (sprintf "--%s / --%s" "do-something-else" "anotherarg") "string" "" "")
                    (sprintf "%s  %s%s%s" (sprintf "--%s / --%s" "turn-it-on" "dont-turn-it-off") "bool" "" "")
                ]
                |> String.concat "\n"
...
module AliasedPositionalsArgParse =
    ...
    type AliasedPositionals with
        ...
        static member parse'
            ...
            let helpText () =
                [
                    (sprintf "%s  %s%s%s" (sprintf "--%s" "count") "int32" "" "")
                    (sprintf
                        "%s  %s%s%s"
...
module FlagsIntoPositionalArgsArgParse =
    ...
    type FlagsIntoPositionalArgs with
        ...
        static member parse'
            ...
            let helpText () =
                [
                    (sprintf "%s  %s%s%s" (sprintf "--%s" "a") "string" "" "")
                    (sprintf
                        "%s  %s%s%s"
                    ...
                    A =
                        (match arg_0 with
                         ...
                         | None ->
                             failwith
                                 "WoofWare.Myriad internal error in generated parser: required argument missing after successful parse")
                    GrabEverything = (arg_1 |> Seq.toList)
                }
            | ArgParserRuntime_BasicNoPositionals.ParseOutcome.HelpRequested ->
                helpText () |> failwithf "Help text requested.\n%s"
            | ArgParserRuntime_BasicNoPositionals.ParseOutcome.Fatal message -> failwith message
                    ...
                    A =
                        (match arg_0 with
                         ...
                         | None ->
                             failwith
                                 "WoofWare.Myriad internal error in generated parser: required argument missing after successful parse")
                    DontGrabEverything = (arg_1 |> Seq.toList)
                }
            | ArgParserRuntime_BasicNoPositionals.ParseOutcome.HelpRequested ->
                helpText () |> failwithf "Help text requested.\n%s"
            | ArgParserRuntime_BasicNoPositionals.ParseOutcome.Fatal message -> failwith message
    ...
    let parse' (getEnvironmentVariable : string -> string option) (args : string list) : WithTypeHelp =
        let helpText () =
            [
                ...
                (sprintf "%s  %s%s%s" (sprintf "--%s" "verbose") "bool" "" (sprintf " : %s" ("Enable verbose output")))
                (sprintf "%s  %s%s%s" (sprintf "--%s" "port") "int32" "" "")
            ]
            |> String.concat "\n"
        ...
        let helpText () =
            [
                ...
                (sprintf
                    ...
                    "string"
                    ""
                    (sprintf " : %s" ("Input file to process")))

                (sprintf "%s  %s%s%s" (sprintf "--%s" "output-dir") "string" "" (sprintf " : %s" ("Output directory")))
...
module NonPositionalBoolList =
    let parse' (getEnvironmentVariable : string -> string option) (args : string list) : NonPositionalBoolList =
        let helpText () =
            [
                (sprintf "%s  %s%s%s" (sprintf "--%s" "flags") "bool" " (can be repeated)" "")
            ]
            |> String.concat "\n"
...
/// Methods to parse arguments for the type AwkwardDefaultName
[<AutoOpen>]
module AwkwardDefaultNameArgParse =
    /// Extension methods for argument parsing
    type AwkwardDefaultName with
        ...
        static member parse'
            ...
            let helpText () =
                [
                    (sprintf
                        ...
                        "int32"
                        (AwkwardDefaultName.``Defaultspace in name``().ToString ()
                         |> sprintf " (default value: %s)")
                        "")

                    (sprintf "%s:" "group name (optional; a default is used if omitted)")
                    (sprintf "  %s  %s%s%s" (sprintf "--%s" "grp-thing1") "int32" "" "")
                    (sprintf "  %s  %s%s%s" (sprintf "--%s" "grp-thing2") "string" "" "")
                    (sprintf "%s:" "optional group (optional)")
                    (sprintf "  %s  %s%s%s" (sprintf "--%s" "opt-thing1") "int32" "" "")
                    (sprintf "  %s  %s%s%s" (sprintf "--%s" "opt-thing2") "string" "" "")
                ]
                |> String.concat "\n"
            ...
            let mutable arg_0 : Choice<int, int> option = None
            let mutable arg_2 : int option = None
            let mutable arg_3 : string option = None
            let mutable arg_5 : int option = None
            let mutable arg_6 : string option = None
            ...
            let parser_applyDefault (leafId : int) : string option =
                match leafId with
                | 0 ->
                    arg_0 <- Some (Choice2Of2 (AwkwardDefaultName.``Defaultspace in name`` ()))
                    None
                | _ -> failwith "WoofWare.Myriad internal error in generated parser: unknown defaulted argument id"
            ...
            | ArgParserRuntime_BasicNoPositionals.ParseOutcome.Success parser_selection ->
                {
                    ``group name`` =
                        ...
                        | Some 1 -> Choice2Of2 (AwkwardDefaultName.``Defaultgroup name`` ())
                        | _ ->
                            failwith
                                "WoofWare.Myriad internal error in generated parser: no case selected despite a successful parse"
                    ``optional group`` =
                        match Map.tryFind 4 parser_selection.Choices with
                        | Some 0 ->
                            Some (
                                {
                                    Thing1 =
        ...
        static member parse (args : string list) : AwkwardDefaultName =
            AwkwardDefaultName.parse' (System.Environment.GetEnvironmentVariable >> Option.ofObj) args
