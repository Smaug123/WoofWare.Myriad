...
module private ArgParserRuntime_PrefixedParent =
    open System
...
/// Methods to parse arguments for the type PrefixedParent
[<AutoOpen>]
module PrefixedParentArgParse =
    /// Extension methods for argument parsing
    type PrefixedParent with
                    ...
                    Leaves =
                        [
                            ...
                            }
                            {
                                ...
                                Forms = [ "and-another" ]
                                AcceptsNegation = false
                                Arity = ArgParserRuntime_PrefixedParent.ErasedArity.BoolLike
                                Repeatable = false
                                Requirement = ArgParserRuntime_PrefixedParent.ErasedRequirement.Required
                                TypeDescription = ""
                                Help = None
                            ...
                            [
                                ArgParserRuntime_PrefixedParent.ErasedTree.Product (
                                    [
                                        ...
                                        ArgParserRuntime_PrefixedParent.ErasedTree.Leaf 1
                                    ]
                                )
                                ArgParserRuntime_PrefixedParent.ErasedTree.Leaf 2
                            ]
                        ))
        ...
        static member parse (args : string list) : PrefixedParent =
            PrefixedParent.parse' (System.Environment.GetEnvironmentVariable >> Option.ofObj) args
namespace ConsumePlugin

open WoofWare.Myriad.Plugins

/// Methods to parse arguments for the type Transfer
[<AutoOpen>]
module TransferArgParse =
    /// Extension methods for argument parsing
    type Transfer with
                        ...
                        (ArgParserRuntime_PrefixedParent.ErasedTree.Product (
                            [
                                ...
                                ArgParserRuntime_PrefixedParent.ErasedTree.Product (
                                    [
                                        ArgParserRuntime_PrefixedParent.ErasedTree.Leaf 2
                                        ArgParserRuntime_PrefixedParent.ErasedTree.Leaf 3
                                    ]
                                )
                            ]
                        ))
        ...
        static member parse (args : string list) : Transfer =
            Transfer.parse' (System.Environment.GetEnvironmentVariable >> Option.ofObj) args
namespace ConsumePlugin

open WoofWare.Myriad.Plugins

/// Methods to parse arguments for the type PrefixedNested
[<AutoOpen>]
module PrefixedNestedArgParse =
    /// Extension methods for argument parsing
    type PrefixedNested with
        ...
        static member parse (args : string list) : PrefixedNested =
            PrefixedNested.parse' (System.Environment.GetEnvironmentVariable >> Option.ofObj) args
namespace ConsumePlugin

open WoofWare.Myriad.Plugins

/// Methods to parse arguments for the type PrefixedFlattened
[<AutoOpen>]
module PrefixedFlattenedArgParse =
    /// Extension methods for argument parsing
    type PrefixedFlattened with
        ...
        static member parse (args : string list) : PrefixedFlattened =
            PrefixedFlattened.parse' (System.Environment.GetEnvironmentVariable >> Option.ofObj) args
namespace ConsumePlugin

open WoofWare.Myriad.Plugins

/// Methods to parse arguments for the type PrefixedThroughUnprefixed
[<AutoOpen>]
module PrefixedThroughUnprefixedArgParse =
    /// Extension methods for argument parsing
    type PrefixedThroughUnprefixed with

        static member parse'
            (getEnvironmentVariable : string -> string option)
            (args : string list)
            : PrefixedThroughUnprefixed
            =
            let helpText () =
                [
                    (sprintf "%s:" "Middle")
        ...
        static member parse (args : string list) : PrefixedThroughUnprefixed =
            PrefixedThroughUnprefixed.parse' (System.Environment.GetEnvironmentVariable >> Option.ofObj) args
namespace ConsumePlugin
...
module PrefixedLongFormsArgParse =
    ...
    type PrefixedLongForms with
        ...
        static member parse (args : string list) : PrefixedLongForms =
            PrefixedLongForms.parse' (System.Environment.GetEnvironmentVariable >> Option.ofObj) args
namespace ConsumePlugin

open WoofWare.Myriad.Plugins

/// Methods to parse arguments for the type PrefixedNegation
[<AutoOpen>]
module PrefixedNegationArgParse =
    /// Extension methods for argument parsing
    type PrefixedNegation with
        ...
        static member parse (args : string list) : PrefixedNegation =
            PrefixedNegation.parse' (System.Environment.GetEnvironmentVariable >> Option.ofObj) args
namespace ConsumePlugin

open WoofWare.Myriad.Plugins

/// Methods to parse arguments for the type PrefixedPositionals
[<AutoOpen>]
module PrefixedPositionalsArgParse =
    /// Extension methods for argument parsing
    type PrefixedPositionals with
                        ...
                        (ArgParserRuntime_PrefixedParent.ErasedTree.Product (
                            [
                                ArgParserRuntime_PrefixedParent.ErasedTree.Product (
                                    [
                                        ArgParserRuntime_PrefixedParent.ErasedTree.Leaf 0
                                        ArgParserRuntime_PrefixedParent.ErasedTree.PositionalLeaf 0
                                    ]
                                )
                            ]
                        ))
                        ...
                        [
                            {
                                Id = 0
                                Forms = [ "pos-rest" ]
                                FlagLike = ArgParserRuntime_PrefixedParent.ErasedFlagLikeBehaviour.Reject
                                TypeDescription = ""
                                Help = None
                            }
                        ]
        ...
        static member parse (args : string list) : PrefixedPositionals =
            PrefixedPositionals.parse' (System.Environment.GetEnvironmentVariable >> Option.ofObj) args
namespace ConsumePlugin

open WoofWare.Myriad.Plugins

/// Methods to parse arguments for the type PrefixedMap
[<AutoOpen>]
module PrefixedMapArgParse =
    /// Extension methods for argument parsing
    type PrefixedMap with
                        ...
                        [
                            {
                                ...
                                Arity = ArgParserRuntime_PrefixedParent.ErasedArity.One
                                Repeatable = true
                                Requirement = ArgParserRuntime_PrefixedParent.ErasedRequirement.Optional
                                TypeDescription = ""
                                Help = None
                            }
                        ]
        ...
        static member parse (args : string list) : PrefixedMap =
            PrefixedMap.parse' (System.Environment.GetEnvironmentVariable >> Option.ofObj) args
namespace ConsumePlugin

open WoofWare.Myriad.Plugins

/// Methods to parse arguments for the type PrefixedUnion
[<AutoOpen>]
module PrefixedUnionArgParse =
    /// Extension methods for argument parsing
    type PrefixedUnion with
            ...
            let parser_schema : ArgParserRuntime_PrefixedParent.ErasedSchema =
                {
                    ...
                    Tree =
                        (ArgParserRuntime_PrefixedParent.ErasedTree.Product (
                            [
                                ArgParserRuntime_PrefixedParent.ErasedTree.Sum (
                                    (0,
                                     [
                                         ("Auto",
                                          ArgParserRuntime_PrefixedParent.ErasedTree.Product (
        ...
        static member parse (args : string list) : PrefixedUnion =
            PrefixedUnion.parse' (System.Environment.GetEnvironmentVariable >> Option.ofObj) args
