  ...
  outputs = {
    ...
    in {
      packages = {
        ...
        fsharp-analyzers = dotnetTool "fsharp-analyzers" (builtins.fromJSON (builtins.readFile ./.config/dotnet-tools.json)).tools.fsharp-analyzers.version "sha256-yGc4oV1fEAfeWUf/y60VUeps3lJWnvVjomWFeVEyXVE=";
        fetchDeps = let
          flags = [];
